...
class RolePermissionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the RolePermission entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "createdOn":"2020-01-01T00:00:00.000Z", "createdBy":"SAMPLE_TEXT", "updatedOn":"2020-01-01T00:00:00.000Z", "updatedBy":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
