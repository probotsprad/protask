...
class EmployeeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .repeat(2) {
            ...
            .post("/api/employees")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "staffName":"SAMPLE_TEXT", "dateOfBirth":"2020-01-01T00:00:00.000Z", "gender":"SAMPLE_TEXT", "emailId":"SAMPLE_TEXT", "qualification":"SAMPLE_TEXT", "designation":"SAMPLE_TEXT", "experience":"SAMPLE_TEXT", "phoneNo":null, "userName":"SAMPLE_TEXT", "password":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
