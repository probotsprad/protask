...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .post("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "taskName":"SAMPLE_TEXT", "taskDescription":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "remainder":"2020-01-01T00:00:00.000Z", "duration":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
